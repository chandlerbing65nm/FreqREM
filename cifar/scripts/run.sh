...
# python /users/doloriel/work/Repo/FreqREM/cifar/scripts/entropy_freq_masking_trend_cifar10c.py \
#   --data_dir /scratch/project_465002264/datasets/cifar10c \
#   --ckpt_dir /users/doloriel/work/Repo/FreqREM/ckpt \
#   --checkpoint /users/doloriel/work/Repo/FreqREM/ckpt/vit_base_384_cifar10.t7 \
#   --batch_size 50 \
...
python cifar/scripts/entropy_random_token_masking_trend_cifar10c.py \
  ...
  --ckpt_dir /users/doloriel/work/Repo/FreqREM/ckpt \
  --checkpoint /users/doloriel/work/Repo/FreqREM/ckpt/vit_base_384_cifar10.t7 \
  --out_dir /users/doloriel/work/Repo/FreqREM/cifar/plots/TokenREM \
  --num_examples 100 \
  --severity 5 \
  --batch_size 20 \
  --progression 0 100 10 \
  --save_mask_examples 3 \
  --mask_example_levels 0 10 20 \
  --mask_figs_dir /users/doloriel/work/Repo/FreqREM/cifar/figs/TokenREM \
  --patch_size 8 \
  --masking_mode random \
  --random_seed 42 \
  --example_class airplane