...
def evaluate(description):
    ...
    checkpoint = torch.load("/users/doloriel/work/Repo/SPARE/ckpt/pretrain_cifar100.t7", map_location='cpu')
...
def setup_spare(model):
    ...
    params, _ = spare.collect_params(model, ln_quarter=cfg.MODEL.LN_QUARTER)
...
if __name__ == '__main__':
    evaluate('CIFAR-100-C evaluation with SPARE (entropy-masked REM).')
